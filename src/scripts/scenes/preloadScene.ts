...
export default class PreloadScene extends Scene {
  ...
  async preload() {
    ...
    this.load.atlas("banners", "/assets/sheets/banners.webp", "/assets/sheets/banners.json");
    this.load.atlas("unit-summary", "/assets/sheets/unit-summary.webp", "/assets/sheets/unit-summary.json");
    this.load.atlas("skill-icons", "/assets/sheets/skill-icons.png", "/assets/sheets/skill-icons.json");
    ...
    this.load.image("attack-forecast", "/assets/sheets/banner-previews/attack-preview.png");
    this.load.image("assist-forecast", "/assets/sheets/banner-previews/ally-assist-preview.png");
    this.load.audio("player-phase", "/assets/audio/files/transitions/player-phase.ogg");
    this.load.audio("enemy-phase", "/assets/audio/files/transitions/enemy-phase.ogg");
