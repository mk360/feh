...
module.exports = async function downloadHeroAssets(heroName) {
  ...
  await downloadFile(`https://feheroes.fandom.com/Special:Filepath/${urlName}_BtlFace_BU.webp`, path.join(targetDir, "/portrait.webp"));
  await downloadFile(`https://feheroes.fandom.com/Special:Filepath/${urlName}_BtlFace_BU_D.webp`, path.join(targetDir, "/portrait-damage.webp"));
